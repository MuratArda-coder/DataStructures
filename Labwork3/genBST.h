...
public:
	...
	void findNumberSmallerThan(int value,BSTNode<T>* p);
	void findNthSmallest(int count,int N,BSTNode<T>* p);
	int findNumberOfParentsWhoHasTwoChildren(BSTNode<T>* p);


	void findNumberSmallerThan(int value);
	void findNthSmallest(int N);
	int findNumberOfParentsWhoHasTwoChildren();
protected:
    BSTNode<T>* root;
